...
output_file_location <- "~/ss/baypass/data_runs_C2_BF/"
...
pod_xtx_file_location <- "~/ss/baypass/POD/simulated_genofiles_data_runs/"
...
pod_c2_file_location <- "~/ss/baypass/POD/simulated_genofiles_data_runs/"
...
#   theme_bw() +
#   ggtitle( paste("Check_computation_of_xtxst_pvalues", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_"))
# 
# ggsave(
#   filename = paste("ggsave_xtxst_check_pval_comp_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = ""),
...
#   geom_point(alpha=0.5) +
#   theme_bw() +
#   ggtitle( paste("Check_computation_of_C2_pvalues", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_"))
# 
# ggsave(
#   filename = paste("ggsave_C2_check_pval_comp_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = ""),
...
#   theme_bw() +
#   ggtitle( paste("xtx_hist", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_"))
# 
# ggsave(
#   filename = paste("ggsave_xtx_hist_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = ""),
#   plot = xtx_hist_plot,
#   device = "png",
#   dpi = 300,
#   width = 200,
...
#   geom_histogram(bins=20, boundary=0, closed="left") +
#   theme_bw() +
#   ggtitle( paste("xtxst_hist", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_"))
# 
# ggsave(
#   filename = paste("ggsave_xtxst_hist_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = ""),
...
#   theme_bw() +
#   ggtitle( paste("xtxst_pval_hist", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_"))
# 
# ggsave(
#   filename = paste("ggsave_xtxst_pval_hist_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = "" ),
...
#   geom_histogram(binwidth =0.05, boundary=0, closed="left") +
#   theme_bw() +
#   ggtitle( paste("C2_hist", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_"))
# 
# ggsave(
#   filename = paste("ggsave_C2_std_hist_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = ""),
#   plot = C2_std_plot,
#   device = "png",
#   dpi = 300,
#   width = 200,
...
#   geom_histogram(binwidth =0.05, boundary=0, closed="left") +
#   theme_bw() +
#   ggtitle( paste("C2_pval_hist", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_"))
# 
# ggsave(
#   filename = paste("ggsave_C2_pval_hist_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = ""),
#   plot = C2_p_hist_plot,
#   device = "png",
#   dpi = 300,
#   width = 200,
...
#     xlab("Chromsome") +
#     ylab("M_XtX") +
#     ggtitle(paste("M_XtX", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_")) +
#     theme_classic() +
#     theme(
...
# 
# ggsave(
#   filename = paste("ggsave_Mxtx_", substr(xtx_filename, 24, nchar(xtx_filename)-18), "_", quantile_to_use_for_POD, "quant", "_", window_size_kb, "windows", ".png", sep = ""),
#   plot = Mxtx_plot,
#   device = "png",
#   dpi = 200,
#   width = 400,
...
#     xlab("Chromsome") +
#     ylab("XtXst") +
#     ggtitle( paste("XtXst", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_")) +
#     theme_classic() +
#     theme(
#       axis.text.x = element_blank(),
#       axis.ticks.x = element_blank(),
...
# 
# ggsave(
#   filename = paste("ggsave_xtxst_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = ""),
#   plot = xtxst_plot,
#   device = "png",
#   dpi = 300,
#   width = 300,
...
BF_plot <- dd %>%
  ...
  xlab("Chromsome") +
  ylab("BF") +
  ggtitle( paste("BF", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_")) +
  theme_classic() +
  theme(
    axis.text.x = element_blank(),
    axis.ticks.x = element_blank(),
...
ggsave(
  filename = paste("BF_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = ""),
  plot = BF_plot,
  device = "png",
  dpi = 300,
  width = 300,
...
C2_plot <- dd %>% 
  ...
  mutate(CHROM = fct_relevel(CHROM, "LG2", "LG3", "LG4", "LG5", "LG6", "LG7", "LG8", "LG9", "LG10"),
         point_col = case_when( CHROM %in% c("LG2", "LG4", "LG6", "LG8", "LG10") ~ 0, # assign different point colours to odd and even numbered chroms
                                TRUE ~ 1),
  ...
  ylab("C2") +
  # ggtitle( paste("C2", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_")) +
  theme_classic() +
  theme(
    axis.text.x = element_blank(),
    axis.ticks.x = element_blank(),
  ...
  scale_colour_manual(values=c("grey30", "grey60", "red4")) +
  scale_size_manual(values=c(1.5, 1.5, 2.5)) +
    geom_hline(yintercept = pod_c2_threshold_0.999, color = "red4", linetype = "dashed")

ggsave(
  filename = paste("ggsave_C2_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = ""),
  plot = C2_plot,
  device = "png",
  dpi = 300,
  width = 400,
...
#   geom_histogram(binwidth =0.05, boundary=0, closed="left") +
#   theme_bw() +
#   ggtitle(paste("xtx_qval_hist", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_"))
# 
# 
# ggsave(
#   filename = paste("ggsave_xtxst_qval_hist_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = ""),
...
#   geom_histogram(binwidth =0.05, boundary=0, closed="left") +
#   theme_bw() +
#   ggtitle( paste("C2_qval_hist", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_"))
# 
# ggsave(
#   filename = paste("ggsave_C2_qval_hist_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = ""),
#   plot = C2_q_hist_plot,
#   device = "png",
#   dpi = 300,
#   width = 200,
...
plot_bf_C2 <- dd  %>%
  ...
  ggtitle( paste("BF_vs_C2", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_"))


ggsave(filename= paste("BF_v_C2", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep=""),
       plot= plot_bf_C2,
       device= "png",
       dpi= 300,
       width=250,
...
#   ggtitle( paste("XtXst_q-value", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_" )) +
#   theme_classic() +
#   theme(
#     axis.text.x = element_blank(),
#     axis.ticks.x = element_blank(),
...
# 
# ggsave(
#   filename = paste("ggsave_xtxst_qval_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = ""),
#   plot = xtxst_q_plot,
#   device = "png",
#   dpi = 300,
#   width = 300,
...
#   ggtitle( paste("C2_q-value", substr(xtx_filename, 24, nchar(xtx_filename)-18), sep="_")) +
#   theme_classic() +
#   theme(
#     axis.text.x = element_blank(),
#     axis.ticks.x = element_blank(),
...
# 
# ggsave(
#   filename = paste("ggsave_C2_qval_", substr(xtx_filename, 24, nchar(xtx_filename)-18), ".png", sep = ""),
#   plot = C2_q_plot,
#   device = "png",
#   dpi = 300,
#   width = 300,
