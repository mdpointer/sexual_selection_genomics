...
SNPS_BED="${MASTER}/baypass/R/outlier_output/outlier_BEDs/cat_autosomes_X/ss_MonoPoly_autosomesX_sig_c2_snps_allSNPS_run_sorted.bed"
TOP_SNP_REGION="${MASTER}/baypass/R/outlier_output/outlier_BEDs//cat_autosomes_X/ss_MonoPoly_autosomesX_sig_c2_top_snp_per_region_allSNPS_run_sorted.bed"
...
bcftools view -i 'INFO/ANN[*] ~ "synonymous_variant"' -r LG2,LG3,LG4,LG5,LG6,LG7,LG8,LG9,LG10,LGX ${ANNOTATED_VCF} -Oz -o ${ANNOTATED_FULL_VCF_SYN}  ## CHECK THAT I CAN GREP THE ANNOTATED VCF FOR THESE REGEXs


bcftools view -i 'INFO/ANN[*] ~ "missense_variant"' -r LG2,LG3,LG4,LG5,LG6,LG7,LG8,LG9,LG10,LGX ${ANNOTATED_VCF} -Oz -o ${ANNOTATED_FULL_VCF_MIS}


bcftools view -i 'INFO/ANN[*] ~ "stop_gained"' -r LG2,LG3,LG4,LG5,LG6,LG7,LG8,LG9,LG10,LGX ${ANNOTATED_VCF} -Oz -o ${ANNOTATED_FULL_VCF_NON}
