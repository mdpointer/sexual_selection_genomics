...
C2_snps_file<- "/Users/mdp/Google Drive/WORK/tribolium_postdoc/ss_lines/ss_genomics/data/baypass/outlier_output/ss_baypass_datarun_6pop_MonoPoly_onlyAUTOSOMES_allREG_allSNPs_summary_contrast.outbaypass_c2_outlier_snps_pod0.999"
...
data %>% 
  ...
  write_delim("/Users/mdp/Google Drive/WORK/tribolium_postdoc/ss_lines/ss_genomics/data/baypass/outlier_output/ss_MonoPoly_autosomes_sig_c2_snps_allSNPS_run.bed",
              delim="\t",
              col_names=F,
              quote="none")
...
region_df %>% 
write_delim("/Users/mdp/Google Drive/WORK/tribolium_postdoc/ss_lines/ss_genomics/data/baypass/outlier_output/ss_MonoPoly_autosomes_baypass_C2_significant_regions_50kb.tsv",
            delim="/t",
            col_names=F,
            quote = "none")
...
region_df %>% 
  ...
  select(CHROM, start, end) %>% 
  write_delim("/Users/mdp/Google Drive/WORK/tribolium_postdoc/ss_lines/ss_genomics/data/baypass/outlier_output/ss_MonoPoly_autosomes_sig_c2_regions_allSNPS_run.bed",
              delim="\t",
              col_names=F,
              quote="none")
...
top_snps %>% 
  select(CHROM, POS) %>% 
write_delim("/Users/mdp/Google Drive/WORK/tribolium_postdoc/ss_lines/ss_genomics/data/baypass/outlier_output/ss_MonoPoly_autosomes_sig_c2_top_snp_per_region_allSNPS_run.tsv",
            delim="\t",
            col_names=F,
            quote="none")
...
top_snps %>%
  ...
  select(chrom, start, end) %>%
  write_delim("/Users/mdp/Google Drive/WORK/tribolium_postdoc/ss_lines/ss_genomics/data/baypass/outlier_output/ss_MonoPoly_autosomes_sig_c2_top_snp_per_region_allSNPS_run.bed",
              delim="\t",
              col_names=F,
              quote="none")
