...
# List VCF files
vcfs="${ANNOTATED_FULL_VCF_MIS_SIFT_DEL} ${ANNOTATED_FULL_VCF_MIS_SIFT_TOL} ${ANNOTATED_FULL_VCF_MIS_SIFT_DEL_HIGHCONF} ${ANNOTATED_SNPS_VCF_MIS_SIFT_DEL} ${ANNOTATED_SNPS_VCF_MIS_SIFT_TOL} ${ANNOTATED_SNPS_VCF_MIS_SIFT_DEL_HIGHCONF}"
